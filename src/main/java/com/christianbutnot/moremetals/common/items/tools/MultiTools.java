...
public class MultiTools extends DiggerItem {
	
	//this code is from cucumber library, useable by MIT licens copyright, only here to make the mod independent from cucumberlibrary for playeruse
	public MultiTools(Tier tier) {
        this(tier, p -> p);
    }

    public MultiTools(Tier tier, Function<Properties, Properties> properties) {
        super(4.0F, -3.2F, tier, CustomTags.Blocks.MINEABLE_BY_MULTI_TOOL, properties.apply(new Properties()
