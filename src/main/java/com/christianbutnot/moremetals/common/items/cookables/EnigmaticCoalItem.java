...
public class EnigmaticCoalItem extends Item {
	...
	public EnigmaticCoalItem(Properties properties) {
		super(properties);
	}
	...
	public void appendHoverText(ItemStack stack, @Nullable TooltipContext level, TooltipDisplay tooltipDisplay, Consumer<Component> components,
	    ...
	    components.accept(Component.literal("Cooks 72 Items").withStyle(ChatFormatting.GRAY).withStyle(ChatFormatting.ITALIC));
